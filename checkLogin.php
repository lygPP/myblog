<?php
    ...
    */
    ...
    $result = mysql_query("select * from user where username='".$_REQUEST['username']."' and password = '".$_REQUEST['password']."'");
    if($_SESSION['validationcode']==$_REQUEST['validation']&&$result = mysql_fetch_assoc($result)){
        //
