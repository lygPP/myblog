<?php /* Smarty version 2.6.18, created on 2016-05-13 06:57:59
         compiled from newArtical.html */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
" alt="">
		...
		<div class="rights" id="art">
				<form action="addarticle.php" method="post">
					<p class="defp">博文标题</p>
					<input class="defi" type="text" placeholder="博文标题" required="required" name="articletitle">
					<p class="defp">关键字 / 标签</p>
					<input class="defi" type="text" placeholder="关键字 / 标签（用逗号隔开）" required="required" name="articlesummary">
					<p class="defp">博文内容</p>
					<div class="show" >
						<script type="text/plain" id="myEditor" style="width:100%;height:350px;">
							<textarea name="articletext">你是住吗</textarea> 
						</script>
					</div>
					<div class="btn">
